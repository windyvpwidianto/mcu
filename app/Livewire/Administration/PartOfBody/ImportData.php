...
use App\Imports\BodyPartImport;
...
class ImportData extends Component
{
    ...
    public function import()
    {
        ...
        try {
            ...
            Excel::import(new BodyPartImport, $path);

            // 3. Berhasil
            $this->dispatch('alert', [
                'text' => "Body Part imported successfully!",
                'duration' => 5000,
                'destination' => '/contact',
                'newWindow' => true,
                'close' => true,
    ...
    {
        return view('livewire.administration.part-of-body.import-data');
    }
}
